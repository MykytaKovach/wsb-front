...
const trip=(props)=>{
    ...
    return(
        <div className={styles.Trip}>
            <p className={styles.Name}><b>{props.flight.createdBy.firstName.charAt(0).toUpperCase() + props.flight.createdBy.firstName.slice(1) + ' ' + props.flight.createdBy.lastName.charAt(0).toUpperCase() + props.flight.createdBy.lastName.slice(1)}</b> - {Convert(new Date(props.flight.createdAt))}</p>
            ...
            <div>
             ...
             <i className="fas fa-arrow-right"></i>
                ...
                <p><b>Total price:</b> {(+props.flight.selectedFlight.price.total + +props.flight.selectedReturnFlight.price.total).toFixed(2)}&#8364;</p>
                 <p><b>Total trip duration:</b> {duration/86400000*-1 }</p>
                 </div>
                 <div style={{textAlign:'start'}}>
                <p className={styles.Paragraph}> Preview: <NavLink to={`/trip/${props.flight._id}`}><i className="far fa-eye" ></i></NavLink></p>
